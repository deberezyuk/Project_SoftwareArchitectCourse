...
* **QA-8**: **Хранение данных** (UC-4)
    ...
    - информация по поездкам должна быть доступна в течение 2-х календарных месяцов с момента формирования поездки.

![ArchCharacteristicsWorksheet](images/ArchiCharacteristics.jpg)
